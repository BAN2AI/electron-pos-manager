...
$.get(url + 'invoices', () => {
    ...
    sales.forEach((el, index) => {
        ...
        salesamount += parseInt(el.totale);
    ...
    $("#sales-amount").html("Fc " + salesamount);
...
let fd = {};
    ...
    <h4> <strong>EL-ROHI</strong></h3>
    <h6> <strong>ALIMENTATION ET DIVERS </strong></h6>
    <h6> Adresse: N. 1788, ROUTE LIKASI, C/KAMPEMBA </h6>
    <h6> Nom du client : ${$("#client").val()}</h6>
   ...
   <h6>LES MARCHANDISES VENDUES NE SONT NI REPRISES NI ECHANGEES</h6>
   </body>
